...
C_SRCS += \
C:/dev/git/tron2024/mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/hllint_tbl.c \
C:/dev/git/tron2024/mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/intvect_tbl.c 

S_UPPER_SRCS += \
C:/dev/git/tron2024/mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/hllint_ent.S 
...
mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/hllint_ent.o: C:/dev/git/tron2024/mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/hllint_ent.S mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/subdir.mk
...
mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/hllint_tbl.o: C:/dev/git/tron2024/mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/hllint_tbl.c mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/subdir.mk
...
mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/intvect_tbl.o: C:/dev/git/tron2024/mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/intvect_tbl.c mtk3_bsp2/mtkernel/kernel/sysdepend/cpu/rx231/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m7 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32H723xx -D_STM32CUBE_NUCLEO_H723_ -c -I../Core/Inc -I../Drivers/STM32H7xx_HAL_Driver/Inc -I../Drivers/STM32H7xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32H7xx/Include -I../Drivers/CMSIS/Include -I"C:/dev/git/tron2024/mtk3_bsp2" -I"C:/dev/git/tron2024/mtk3_bsp2/config" -I"C:/dev/git/tron2024/mtk3_bsp2/include" -I"C:/dev/git/tron2024/mtk3_bsp2/mtkernel/kernel/knlinc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv5-d16 -mfloat-abi=hard -mthumb -o "$@"
